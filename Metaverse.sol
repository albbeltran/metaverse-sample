...
contract Metaverse is ERC721, Ownable {
    ...
    function mint(string memory _name, int8 _w, int8 _h, int8 _d, int8 _x, int8 _y, int8 _z) 
        public payable {
    ...
    // Obtainer a user's Metaverse buildings
